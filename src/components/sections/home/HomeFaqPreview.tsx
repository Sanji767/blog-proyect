...
export default function HomeFaqPreview() {
  return (
    <section className="border-t border-border bg-hero-background/60 py-12 md:py-16">
      <Container className="space-y-6">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {faqs.map((item) => (
            <details
              key={item.question}
              className="group rounded-2xl border border-border bg-background/90 p-4 text-sm shadow-sm"
            >
